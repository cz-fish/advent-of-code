    ...
    for (let ln of raw_input.split('\n')) {
        ...
        for (let i = 0; i < grid.width; ++i) {
            ...
            if (c !== '.') {
                ...
                (_a = grid.antennas.get(c)) === null || _a === void 0 ? void 0 : _a.push([row, i]);
            }
        }
        row++;
    }
...
const find_antinodes = (grid, resonance) => {
...
export { Grid, find_antinodes, get_antenna_pairs, parse_input, part1, part2, };
